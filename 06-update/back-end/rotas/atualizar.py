...
$ curl -X PUT -d '{"id":1, "nome":"Teresa", "email":"te@gmail.com", "telefone":"123456789", "sexo":"feminino"}' -H "Content-Type:application/json" localhost:5000/atualizar/Pessoa 
{
  "detalhes": "ok", 
  "resultado": "ok"
}
...
curl -X PUT -d '{"nome":"Paulo", "email":"pa@gmail.com", "telefone":"123456789", "sexo":"feminino"}' -H "Content-Type:application/json" localhost:5000/atualizar/Pessoa 
{
  "detalhes": "Atributo id n\u00e3o encontrado", 
  "resultado": "erro"
}

AUSÊNCIA DO CAMPO TELEFONE E SEXO:
